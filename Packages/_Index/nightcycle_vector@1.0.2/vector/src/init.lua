...
export type Vector = {
	...
	Magnitude: number,
	Type: string,
	__add: ((self: Vector, other: Vector) -> Vector)
	& ((self: Vector, other: number) -> Vector),
	__sub: ((self: Vector, other: Vector) -> Vector)
	& ((self: Vector, other: number) -> Vector),
	__mul: ((self: Vector, other: Vector) -> Vector)
	& ((self: Vector, other: number) -> Vector),
	__div: ((self: Vector, other: Vector) -> Vector)
	& ((self: Vector, other: number) -> Vector),
	__pow: ((self: Vector, other: Vector) -> Vector)
	& ((self: Vector, other: number) -> Vector),
	__mod: ((self: Vector, other: Vector) -> Vector)
	& ((self: Vector, other: number) -> Vector),
